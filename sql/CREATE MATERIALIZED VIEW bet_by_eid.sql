DROP MATERIALIZED VIEW multimatrix.bet_by_eid;

CREATE MATERIALIZED VIEW multimatrix.bet_by_eid AS
    SELECT *
    ...
    PRIMARY KEY (event_id, market_id, event_type_id, selection_id, bet_id, account_id, state, side, status, placed_date);
