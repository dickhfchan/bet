DROP MATERIALIZED VIEW multimatrix.bet_by_state_mid;

CREATE MATERIALIZED VIEW multimatrix.bet_by_state_mid AS
    SELECT *
    ...
    PRIMARY KEY ((state, market_id), account_id, status, settled_date, placed_date, bet_id, selection_id, event_type_id, side, event_id);
