DROP MATERIALIZED VIEW multimatrix.bet_by_state_aid;

CREATE MATERIALIZED VIEW multimatrix.bet_by_state_aid AS
    SELECT *
    ...
    PRIMARY KEY (state, account_id, status, placed_date, market_id, bet_id, selection_id, event_type_id, side, event_id);
