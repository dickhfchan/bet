DROP MATERIALIZED VIEW multimatrix.bet_by_state_eid;

CREATE MATERIALIZED VIEW multimatrix.bet_by_state_eid AS
    SELECT *
    ...
    PRIMARY KEY ((state, event_id), account_id, status, settled_date, market_id, placed_date, bet_id, selection_id, event_type_id, side);
