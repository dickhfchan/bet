DROP MATERIALIZED VIEW multimatrix.bet_by_mid_state_aid;

CREATE MATERIALIZED VIEW multimatrix.bet_by_mid_state_aid AS
    SELECT *
    ...
    PRIMARY KEY ((market_id, state), account_id, status, placed_date, bet_id, selection_id, event_type_id, side, event_id);
