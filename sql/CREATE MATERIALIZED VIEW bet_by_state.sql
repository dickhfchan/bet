DROP MATERIALIZED VIEW multimatrix.bet_by_state;

CREATE MATERIALIZED VIEW multimatrix.bet_by_state AS
    SELECT *
    ...
    PRIMARY KEY (state, account_id, status, settled_date, market_id, placed_date, bet_id, selection_id, event_type_id, side, event_id);
